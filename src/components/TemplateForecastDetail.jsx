...
function TemplateForecastDetail(props) {
    return (
        <div className='flex flex-col items-center p-2 py-4 m-2 space-y-1 rounded-full outline outline-sky-100 outline-1 cursor-pointer transition ease-out hover:scale-x-90 '>
